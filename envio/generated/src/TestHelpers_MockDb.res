...
@genType
and entities = {
    @as("Event_BatchTransferExecuted") event_BatchTransferExecuted: entityStoreOperations<Entities.Event_BatchTransferExecuted.t>,
    @as("Event_TransferExecuted") event_TransferExecuted: entityStoreOperations<Entities.Event_TransferExecuted.t>,
    @as("Event_TransferFailed") event_TransferFailed: entityStoreOperations<Entities.Event_TransferFailed.t>,
  }
  ...
  let entities = {
      event_BatchTransferExecuted: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Event_BatchTransferExecuted)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Event_BatchTransferExecuted.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      event_TransferExecuted: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Event_TransferExecuted)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Event_TransferExecuted.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      event_TransferFailed: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Event_TransferFailed)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Event_TransferFailed.t,
            >
          ),
          ~getKey=({id}) => id,
        )
